...
export const resultTypes = {
  MQ: {
    ...
    keywords: ['호기심', '탐구', '만들기', '문제해결'],
    activities: ['과학 실험', '로봇 만들기', '관찰하기', '발명 아이디어 내기'],
    tip: '궁금한 것이 생기면 직접 관찰하고 만들어 보면서 답을 찾아보세요!',
    hero: '장영실',
  ...
  MA: {
    ...
    keywords: ['창의성', '만들기', '표현력', '상상력'],
    activities: ['그림 그리기', '모형 만들기', '공간 꾸미기', '영상 만들기'],
    tip: '새로운 것을 직접 만들어 보고, 내 생각을 작품으로 표현해보세요!',
    hero: '백남준',
  ...
  MH: {
    ...
    keywords: ['배려', '실습', '사람 돕기', '책임감'],
    activities: ['친구 도와주기', '운동 활동', '응급·안전 체험', '봉사활동'],
    tip: '친구를 도와주거나 다른 사람에게 도움이 되는 활동을 경험해보세요!',
    hero: '허준',
  ...
  ML: {
    ...
    keywords: ['리더십', '도전', '현장 해결', '용기'],
    activities: ['팀 활동', '스포츠', '문제 해결하기', '프로젝트 이끌기'],
    tip: '어려운 상황에서도 침착하게 방법을 찾고 친구들과 함께 해결해보세요!',
    hero: '이순신',
  ...
  MP: {
    ...
    keywords: ['꼼꼼함', '정확성', '안전', '관리'],
    activities: ['지도 그리기', '순서 정하기', '점검하기', '규칙 만들기'],
    tip: '차근차근 살피고 정확하게 완성하는 경험을 쌓아보세요!',
    hero: '김정호',
  ...
  QA: {
    ...
    keywords: ['상상력', '탐구', '표현', '글쓰기'],
    activities: ['글쓰기', '그림 그리기', '과학 관찰', '이야기 만들기'],
    tip: '궁금한 것을 탐구하고, 발견한 것을 글이나 그림으로 표현해보세요!',
    hero: '윤동주',
  ...
  QH: {
    ...
    keywords: ['배움', '도움', '이해', '소통'],
    activities: ['친구 가르치기', '독서', '질문하기', '토론하기'],
    tip: '궁금한 것을 깊이 탐구하고, 배운 것을 친구들과 나눠보세요!',
    hero: '주시경',
  ...
  QL: {
    ...
    keywords: ['전략', '기획', '리더십', '생각'],
    activities: ['기획하기', '토론', '연구', '발표하기'],
    tip: '크게 생각하고, 미래를 상상하며 계획을 세워보세요!',
    hero: '정도전',
  ...
  QP: {
    ...
    keywords: ['분석', '기록', '정리', '꼼꼼함'],
    activities: ['자료 정리하기', '기록하기', '숫자 비교하기', '그래프 만들기'],
    tip: '자료를 정리하고 비교하면서 내가 발견한 것을 기록해보세요!',
    hero: '김부식',
  ...
  AH: {
    ...
    keywords: ['표현', '공감', '예술', '따뜻함'],
    activities: ['그림 그리기', '음악 듣기', '글쓰기', '친구 위로하기'],
    tip: '따뜻한 마음을 그림이나 글로 표현해보세요!',
    hero: '신사임당',
  ...
  AL: {
    ...
    keywords: ['기획', '표현', '소통', '창의'],
    activities: ['공연 보기', '발표하기', '영상 만들기', '기획하기'],
    tip: '창의적인 생각을 친구들에게 전하는 경험을 해보세요!',
    hero: '나운규',
  ...
  AP: {
    ...
    keywords: ['기록', '예술', '정리', '보존'],
    activities: ['그림 감상', '기록하기', '전시 관람', '자료 정리'],
    tip: '아름다움과 기록을 소중히 여기며 관찰하고 정리해보세요!',
    hero: '김정희',
  ...
  HL: {
    ...
    keywords: ['헌신', '리더십', '공동체', '용기'],
    activities: ['봉사활동', '팀 이끌기', '토론하기', '친구 돕기'],
    tip: '사람들을 생각하고 함께 이끌어가는 경험을 쌓아보세요!',
    hero: '김구',
  ...
  HP: {
    ...
    keywords: ['책임', '봉사', '행정', '성실'],
    activities: ['규칙 지키기', '돕기', '정리하기', '약속 지키기'],
    tip: '책임감 있게 사람들을 돕는 활동에 참여해보세요!',
    hero: '황희',
  ...
  LP: {
    ...
    keywords: ['목표', '운영', '계획', '관리'],
    activities: ['계획 세우기', '역할 나누기', '일정 정리', '목표 세우기'],
    tip: '목표를 세우고 친구들과 함께 하나씩 이루어 보세요!',
    hero: '왕건',
